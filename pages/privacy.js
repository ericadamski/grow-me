...
export default () => (
  <main style={{ padding: "3rem" }}>
    ...
    <p>
      ...
      <a href="https://grow-me.level.codes">https://grow-me.level.codes</a>.
    ...
    <p>
      ...
      regarding the reason you contacted us. We will not share your information
      with any third party outside of our organization, other than as necessary
      to fulfill your request, e.g. to ship an order. Unless you ask us not to,
    ...
    <p>
      ...
      following at any time by contacting us via the email address given below:
      <ul>
    ...
    <p>
      ...
      offline. Wherever we collect sensitive information (such as credit card
      ...
      looking for "https" at the beginning of the address of the Web page. While
      we use encryption to protect sensitive information transmitted online, we
      ...
      <strong>
        ...
        contact us immediately via email: eric.adamski[at]level.codes.
      </strong>
    </p>
  </main>
);
